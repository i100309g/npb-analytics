export const awards: {
  ...
  // MVP
  { seasonYear: 2025, playerId: "giants-1", awardName: "MVP", league: "セントラル" },
  { seasonYear: 2025, playerId: "hawks-1", awardName: "MVP", league: "パシフィック" },

  // 首位打者 (Batting Title)
  { seasonYear: 2025, playerId: "tigers-1", awardName: "首位打者", league: "セントラル" },
  { seasonYear: 2025, playerId: "hawks-1", awardName: "首位打者", league: "パシフィック" },

  // 本塁打王 (Home Run King)
  { seasonYear: 2025, playerId: "giants-1", awardName: "本塁打王", league: "セントラル" },
  { seasonYear: 2025, playerId: "eagles-2", awardName: "本塁打王", league: "パシフィック" },

  // 打点王 (RBI King)
  { seasonYear: 2025, playerId: "baystars-2", awardName: "打点王", league: "セントラル" },
  { seasonYear: 2025, playerId: "hawks-2", awardName: "打点王", league: "パシフィック" },

  // 最多勝 (Most Wins)
  { seasonYear: 2025, playerId: "baystars-4", awardName: "最多勝", league: "セントラル" },
  { seasonYear: 2025, playerId: "hawks-4", awardName: "最多勝", league: "パシフィック" },

  // 最優秀防御率 (Best ERA)
  { seasonYear: 2025, playerId: "giants-4", awardName: "最優秀防御率", league: "セントラル" },
  { seasonYear: 2025, playerId: "buffaloes-4", awardName: "最優秀防御率", league: "パシフィック" },

  // 最多奪三振 (Most Strikeouts)
  { seasonYear: 2025, playerId: "tigers-4", awardName: "最多奪三振", league: "セントラル" },
  { seasonYear: 2025, playerId: "hawks-4", awardName: "最多奪三振", league: "パシフィック" },

  // 沢村賞 (Sawamura Award — no league)
  { seasonYear: 2025, playerId: "hawks-4", awardName: "沢村賞", league: "" },

  // 新人王 (Rookie of the Year)
  { seasonYear: 2025, playerId: "carp-3", awardName: "新人王", league: "セントラル" },
  { seasonYear: 2025, playerId: "fighters-2", awardName: "新人王", league: "パシフィック" },

  // GG賞 (Golden Glove) — 9 awards, one per defensive position
  // P
  { seasonYear: 2025, playerId: "baystars-4", awardName: "GG賞", league: "セントラル" },
  // C
  { seasonYear: 2025, playerId: "tigers-3", awardName: "GG賞", league: "セントラル" },
  // 1B
  { seasonYear: 2025, playerId: "giants-2", awardName: "GG賞", league: "セントラル" },
  // 2B
  { seasonYear: 2025, playerId: "carp-1", awardName: "GG賞", league: "セントラル" },
  // 3B
  { seasonYear: 2025, playerId: "swallows-2", awardName: "GG賞", league: "パシフィック" },
  // SS
  { seasonYear: 2025, playerId: "marines-1", awardName: "GG賞", league: "パシフィック" },
  // OF
  { seasonYear: 2025, playerId: "hawks-2", awardName: "GG賞", league: "パシフィック" },
  // OF
  { seasonYear: 2025, playerId: "eagles-1", awardName: "GG賞", league: "パシフィック" },
  // OF
  { seasonYear: 2025, playerId: "lions-3", awardName: "GG賞", league: "パシフィック" },
];
...
export const matchups: {
  ...
  {
    seasonYear: 2025, batterId: "giants-1", pitcherId: "tigers-4",
  ...
  {
    seasonYear: 2025, batterId: "giants-1", pitcherId: "hawks-4",
  ...
  {
    seasonYear: 2025, batterId: "giants-2", pitcherId: "baystars-5",
  ...
  {
    seasonYear: 2025, batterId: "giants-3", pitcherId: "swallows-4",
  ...
  {
    seasonYear: 2025, batterId: "tigers-1", pitcherId: "giants-4",
  ...
  {
    seasonYear: 2025, batterId: "tigers-1", pitcherId: "eagles-5",
  ...
  {
    seasonYear: 2025, batterId: "tigers-2", pitcherId: "carp-6",
  ...
  {
    seasonYear: 2025, batterId: "tigers-3", pitcherId: "dragons-4",
  ...
  {
    seasonYear: 2025, batterId: "baystars-1", pitcherId: "swallows-5",
  ...
  {
    seasonYear: 2025, batterId: "baystars-2", pitcherId: "marines-4",
  ...
  {
    seasonYear: 2025, batterId: "baystars-2", pitcherId: "hawks-5",
  ...
  {
    seasonYear: 2025, batterId: "baystars-3", pitcherId: "tigers-6",
  ...
  {
    seasonYear: 2025, batterId: "carp-1", pitcherId: "giants-5",
    atBats: 27, hits: 8, doubles: 2, triples: 0, homeRuns: 1,
    rbi: 4, walks: 3, intentionalWalks: 0, strikeouts: 5,
    hitByPitch: 0, sacrificeFlies: 1, avg: 0.296, ops: 0.852,
  },
  {
    seasonYear: 2025, batterId: "carp-2", pitcherId: "buffaloes-4",
  ...
  {
    seasonYear: 2025, batterId: "carp-3", pitcherId: "swallows-6",
  ...
  {
    seasonYear: 2025, batterId: "dragons-1", pitcherId: "tigers-5",
  ...
  {
    seasonYear: 2025, batterId: "dragons-2", pitcherId: "lions-4",
  ...
  {
    seasonYear: 2025, batterId: "dragons-3", pitcherId: "baystars-6",
  ...
  {
    seasonYear: 2025, batterId: "swallows-1", pitcherId: "carp-4",
  ...
  {
    seasonYear: 2025, batterId: "swallows-2", pitcherId: "fighters-5",
  ...
  {
    seasonYear: 2025, batterId: "swallows-3", pitcherId: "dragons-5",
  ...
  {
    seasonYear: 2025, batterId: "hawks-1", pitcherId: "marines-5",
  ...
  {
    seasonYear: 2025, batterId: "hawks-1", pitcherId: "lions-6",
  ...
  {
    seasonYear: 2025, batterId: "hawks-2", pitcherId: "eagles-4",
  ...
  {
    seasonYear: 2025, batterId: "hawks-3", pitcherId: "buffaloes-5",
  ...
  {
    seasonYear: 2025, batterId: "marines-1", pitcherId: "buffaloes-6",
    atBats: 24, hits: 7, doubles: 2, triples: 0, homeRuns: 1,
    rbi: 4, walks: 3, intentionalWalks: 0, strikeouts: 6,
    hitByPitch: 0, sacrificeFlies: 0, avg: 0.292, ops: 0.875,
  },
  {
    seasonYear: 2025, batterId: "marines-2", pitcherId: "giants-6",
    atBats: 19, hits: 5, doubles: 1, triples: 0, homeRuns: 0,
    rbi: 2, walks: 2, intentionalWalks: 0, strikeouts: 5,
    hitByPitch: 1, sacrificeFlies: 0, avg: 0.263, ops: 0.737,
  },
  {
    seasonYear: 2025, batterId: "marines-3", pitcherId: "fighters-4",
  ...
  {
    seasonYear: 2025, batterId: "eagles-1", pitcherId: "hawks-6",
  ...
  {
    seasonYear: 2025, batterId: "eagles-2", pitcherId: "lions-5",
  ...
  {
    seasonYear: 2025, batterId: "eagles-2", pitcherId: "marines-6",
  ...
  {
    seasonYear: 2025, batterId: "eagles-3", pitcherId: "fighters-6",
  ...
  {
    seasonYear: 2025, batterId: "buffaloes-1", pitcherId: "eagles-6",
    atBats: 25, hits: 7, doubles: 2, triples: 0, homeRuns: 1,
    rbi: 4, walks: 3, intentionalWalks: 0, strikeouts: 6,
    hitByPitch: 0, sacrificeFlies: 0, avg: 0.280, ops: 0.840,
  },
  {
    seasonYear: 2025, batterId: "buffaloes-2", pitcherId: "hawks-4",
  ...
  {
    seasonYear: 2025, batterId: "buffaloes-3", pitcherId: "marines-4",
  ...
  {
    seasonYear: 2025, batterId: "lions-1", pitcherId: "fighters-5",
  ...
  {
    seasonYear: 2025, batterId: "lions-2", pitcherId: "buffaloes-4",
  ...
  {
    seasonYear: 2025, batterId: "lions-3", pitcherId: "eagles-5",
  ...
  {
    seasonYear: 2025, batterId: "fighters-1", pitcherId: "marines-5",
    atBats: 24, hits: 7, doubles: 2, triples: 0, homeRuns: 1,
    rbi: 4, walks: 4, intentionalWalks: 0, strikeouts: 6,
    hitByPitch: 0, sacrificeFlies: 0, avg: 0.292, ops: 0.875,
  },
  {
    seasonYear: 2025, batterId: "fighters-2", pitcherId: "lions-4",
    atBats: 20, hits: 7, doubles: 2, triples: 1, homeRuns: 1,
    rbi: 5, walks: 3, intentionalWalks: 0, strikeouts: 4,
    hitByPitch: 1, sacrificeFlies: 0, avg: 0.350, ops: 1.050,
  },
  {
    seasonYear: 2025, batterId: "fighters-3", pitcherId: "hawks-6",
